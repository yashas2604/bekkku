...
- **⌨️ Keyboard Kneading Gym**: Type in the console textbox and watch Bekkku knead its paws in real-time. Typing too fast triggers **Overheat Mode** (cat turns glowing red and vents steam!).
